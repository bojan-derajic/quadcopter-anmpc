...
static emlrtRSInfo ne_emlrtRSI = { 1,  /* lineNo */
  ...
  "C:\\Program Files\\Polyspace\\R2020b\\toolbox\\optim\\+optim\\+coder\\+qpactiveset\\+WorkingSet\\addBoundToActiveSetMatrix_.p"/* pathName */
};
...
static emlrtBCInfo fc_emlrtBCI = { -1, /* iFirst */
  ...
  "C:\\Program Files\\Polyspace\\R2020b\\toolbox\\optim\\+optim\\+coder\\+qpactiveset\\+WorkingSet\\addBoundToActiveSetMatrix_.p",/* pName */
  0                                    /* checkKind */
};
  ...
  TYPE, int32_T idx_local)
{
  ...
  if ((idx_global < 1) || (idx_global > i)) {
    emlrtDynamicBoundsCheckR2012b(idx_global, 1, i, &ec_emlrtBCI, &st);
  }
  ...
  if ((obj->nActiveConstr < 1) || (obj->nActiveConstr > i)) {
    emlrtDynamicBoundsCheckR2012b(obj->nActiveConstr, 1, i, &ec_emlrtBCI, &st);
  }
  ...
  switch (TYPE) {
   case 5:
    ...
    if ((idx_local < 1) || (idx_local > i)) {
      emlrtDynamicBoundsCheckR2012b(idx_local, 1, i, &fc_emlrtBCI, sp);
    }

    idx_bnd_local = obj->indexUB.data[idx_local - 1];
    i = obj->bwset.size[0];
    if ((obj->nActiveConstr < 1) || (obj->nActiveConstr > i)) {
      emlrtDynamicBoundsCheckR2012b(obj->nActiveConstr, 1, i, &fc_emlrtBCI, sp);
    }
  ...
  for (idx = 0; idx <= idx_bnd_local - 2; idx++) {
    ...
    i = obj->ATwset.size[1];
    if ((idx_global < 1) || (idx_global > i)) {
      emlrtDynamicBoundsCheckR2012b(idx_global, 1, i, &fc_emlrtBCI, sp);
    }
  ...
  i = obj->ATwset.size[0];
  if ((idx_bnd_local < 1) || (idx_bnd_local > i)) {
    emlrtDynamicBoundsCheckR2012b(idx_bnd_local, 1, i, &fc_emlrtBCI, sp);
  }
  ...
  switch (obj->probType) {
   ...
   default:
    ...
    if ((obj->nVar < 1) || (obj->nVar > i)) {
      emlrtDynamicBoundsCheckR2012b(obj->nVar, 1, i, &fc_emlrtBCI, sp);
    }
