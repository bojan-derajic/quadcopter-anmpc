                 ...
                 *prhs[])
{
  ...
  d_nlmpcmoveCodeGenerationStackD = (c_nlmpcmoveCodeGenerationStackD *)
    emlrtMxCalloc(1, (size_t)1U * sizeof(c_nlmpcmoveCodeGenerationStackD));
...
void nlmpcmoveCodeGeneration_mexFunction(c_nlmpcmoveCodeGenerationStackD *SD,
  int32_T nlhs, mxArray *plhs[3], int32_T nrhs, const mxArray *prhs[4])
{
