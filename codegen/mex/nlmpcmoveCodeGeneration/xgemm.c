...
void b_xgemm(int32_T m, int32_T k, const real_T A_data[], int32_T lda, const
             real_T B_data[], int32_T ldb, real_T C_data[], int32_T ldc)
{
  ptrdiff_t k_t;
  ptrdiff_t lda_t;
  ptrdiff_t ldb_t;
...
void d_xgemm(int32_T m, int32_T n, int32_T k, const real_T A_data[], int32_T ia0,
             int32_T lda, const real_T B_data[], int32_T ldb, real_T C_data[],
             int32_T ldc)
{
  ptrdiff_t k_t;
  ptrdiff_t lda_t;
...
void xgemm(int32_T m, int32_T k, const real_T A_data[], int32_T lda, const
           real_T B_data[], int32_T ldb, real_T C_data[], int32_T ldc)
{
  ptrdiff_t k_t;
  ptrdiff_t lda_t;
