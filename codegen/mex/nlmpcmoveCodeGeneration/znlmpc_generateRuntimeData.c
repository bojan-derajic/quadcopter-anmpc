...
{
  static const real_T dv3[60] = { 2.8284271247461903, 2.8284271247461903,
    ...
    3.1622776601683795, 3.1622776601683795, 3.1622776601683795,
    3.1622776601683795, 3.1622776601683795, 3.1622776601683795,
    3.1622776601683795, 3.4641016151377544, 3.4641016151377544,
  ...
  for (i = 0; i < 4; i++) {
    userdata->MVTarget[15 * i] = MVTarget0[i];
    for (k = 0; k < 14; k++) {
      userdata->MVTarget[(k + 15 * i) + 1] = MVTarget0[i];
    }
  }
