...
static emlrtRSInfo bf_emlrtRSI = { 1,  /* lineNo */
  ...
  "C:\\Program Files\\Polyspace\\R2020b\\toolbox\\optim\\+optim\\+coder\\+qpactiveset\\+WorkingSet\\moveConstraint_.p"/* pathName */
};
...
static emlrtBCInfo yc_emlrtBCI = { -1, /* iFirst */
  ...
  "C:\\Program Files\\Polyspace\\R2020b\\toolbox\\optim\\+optim\\+coder\\+qpactiveset\\+WorkingSet\\moveConstraint_.p",/* pName */
  0                                    /* checkKind */
};
                     ...
                     idx_global_start, int32_T idx_global_dest)
{
  ...
  if ((idx_global_start < 1) || (idx_global_start > i)) {
    emlrtDynamicBoundsCheckR2012b(idx_global_start, 1, i, &yc_emlrtBCI, sp);
  }

  i = obj->Wid.size[0];
  if ((idx_global_dest < 1) || (idx_global_dest > i)) {
    emlrtDynamicBoundsCheckR2012b(idx_global_dest, 1, i, &yc_emlrtBCI, sp);
  }
  ...
  obj->Wlocalidx.data[idx_global_dest - 1] = obj->
    Wlocalidx.data[idx_global_start - 1];
  b = obj->nVar;
  st.site = &bf_emlrtRSI;
  ...
  for (idx = 0; idx < b; idx++) {
    i = obj->ATwset.size[0];
    if ((idx + 1 < 1) || (idx + 1 > i)) {
      emlrtDynamicBoundsCheckR2012b(idx + 1, 1, i, &yc_emlrtBCI, sp);
    }
