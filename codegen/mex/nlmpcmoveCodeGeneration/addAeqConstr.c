...
static emlrtRSInfo ch_emlrtRSI = { 1,  /* lineNo */
  ...
  "C:\\Program Files\\Polyspace\\R2020b\\toolbox\\optim\\+optim\\+coder\\+qpactiveset\\+WorkingSet\\addAeqConstr.p"/* pathName */
};
...
static emlrtBCInfo xd_emlrtBCI = { -1, /* iFirst */
  ...
  "",                                  /* aName */
  "addAeqConstr",                      /* fName */
  "C:\\Program Files\\Polyspace\\R2020b\\toolbox\\optim\\+optim\\+coder\\+qpactiveset\\+WorkingSet\\addAeqConstr.p",/* pName */
  0                                    /* checkKind */
};
...
void addAeqConstr(const emlrtStack *sp, j_struct_T *obj, int32_T idx_local)
{
  ...
  if ((obj->nActiveConstr == totalEq - 1) && (idx_local > obj->nWConstr[1])) {
    ...
    if ((i1 < 1) || (i1 > i)) {
      emlrtDynamicBoundsCheckR2012b(i1, 1, i, &ec_emlrtBCI, &st);
    }
    ...
    for (idx = 0; idx < b; idx++) {
      ...
      i2 = (iAw0 + idx) + 1;
      if ((i2 < 1) || (i2 > i)) {
        emlrtDynamicBoundsCheckR2012b(i2, 1, i, &xd_emlrtBCI, sp);
      }
    ...
    i = obj->bwset.size[0];
    if ((obj->nActiveConstr < 1) || (obj->nActiveConstr > i)) {
      emlrtDynamicBoundsCheckR2012b(obj->nActiveConstr, 1, i, &xd_emlrtBCI, sp);
    }
    ...
    if ((totalEq < 1) || (totalEq > i)) {
      emlrtDynamicBoundsCheckR2012b(totalEq, 1, i, &xd_emlrtBCI, sp);
    }
