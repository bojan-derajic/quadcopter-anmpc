...
static emlrtRSInfo yf_emlrtRSI = { 1,  /* lineNo */
  "linearForm_",                       /* fcnName */
  "C:\\Program Files\\Polyspace\\R2020b\\toolbox\\optim\\+optim\\+coder\\+qpactiveset\\+Objective\\linearForm_.p"/* pathName */
};
...
static emlrtBCInfo jd_emlrtBCI = { -1, /* iFirst */
  ...
  "",                                  /* aName */
  "linearForm_",                       /* fName */
  "C:\\Program Files\\Polyspace\\R2020b\\toolbox\\optim\\+optim\\+coder\\+qpactiveset\\+Objective\\linearForm_.p",/* pName */
  0                                    /* checkKind */
};
  ...
  if (obj_hasLinear) {
    ...
    for (i = 0; i < obj_nvar; i++) {
      if ((i + 1 < 1) || (i + 1 > f_size[0])) {
        emlrtDynamicBoundsCheckR2012b(i + 1, 1, f_size[0], &jd_emlrtBCI, sp);
      }
